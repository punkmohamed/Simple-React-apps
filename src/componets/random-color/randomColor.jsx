    ...
    return (
        <div style={{
            ...
            <div className="text-center py-5 d-flex justify-content-evenly">
                ...
                <button className="btn btn-success" onClick={colorRGB}>Create RGB Color</button>
            </div>
            <div className="d-flex flex-row justify-content-evenly align-items-center fs-4 mt-5 text-light">
